...
public class ConvertMoney extends AppCompatActivity {
    ...
    ImageView from_currency_image, to_currency_image;

    EditText ed_amount;
    JSONArray CurrencyList = new JSONArray();
    JSONArray WalletList = new JSONArray();
    TextView  tv_currency_to, tv_currency_from;
...
//    ProgressBar pb_showProgress;
    ...
    private LinearLayout lineartodropdown;

    @Override
    protected void onCreate(Bundle savedInstanceState)
       {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.convertmoney);
        getScreenHeight();
        init();
        addMoneyList();
    }
    ...
    private void init()
    {
        ...
        to_currency_image = findViewById(R.id.to_currency_image);
//        txt_current_balance = findViewById(R.id.txt_current_balance);
        tv_currency_to = findViewById(R.id.tv_currency_to);
        ...
        lineartodropdown = findViewById(R.id.lineartodropdown);
//      pb_showProgress = findViewById(R.id.pb_showProgress);
        ...
        linearfromdropdown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showListingPopup("From Currency", WalletList, from_currency_image, tv_currency_from);
            }
        });


        lineartodropdown.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showListingPopup("To Currency", CurrencyList, to_currency_image, tv_currency_to);
            }
        });
    ...
    public void addMoneyList() {
        ...
        m.put("MemberId", UtilClass.member_id);
        new ServerHandler().sendToServer(ConvertMoney.this, "AddMoneyList", m, 0, 1, new CallBack() {
            @Override
                    ...
                    if (jsonObject.getBoolean("status")) {
                       ...
                       // txt_current_balance.setText("Balance : " + Totalbalance + DefaultFromSymbol);
                        ...
                        for(int x=0;x<CurrencyList.length();x++)
                        {
                            ...
                            System.out.println("Toflag==="+currencyData.getString("Symbol")+"==="+DefaultFromSymbol);
                        ...
                        System.out.println("To symbole====="+toSymbolImage+"=="+DefaultToSymbol);

                        showImage(toSymbolImage, to_currency_image);
                        tv_currency_to.setText(DefaultFromSymbol);
        ...
        try {
            ...
            if (currencyAray != null) {
                if (currencyAray.length() > 0)
                {
                    ...
                    CurrencyAdapter mAdapter = new CurrencyAdapter(currencyAray, currencyTitle, ConvertMoney.this, currencyImg, currencySymble);
    ...
    public void calculateApi(Map<String, String> m,int progress)
    {
        ...
        new ServerHandler().sendToServer(ConvertMoney.this, "ConvertCalculation", m, progress, 1, new CallBack() {
            @Override
            public void getRespone(String dta, ArrayList<Object> respons) {
                try {
                    System.out.println("Convert Amount list===" + dta);
...
//
//
//                        txt_youwillpay.setText(calculationObj.getString("FromAmount") + "" + tv_currency_to.getText());
//                        txt_totalfee.setText(calculationObj.getString("Fees") + "" + tv_currency_to.getText());
//                        txt_amountwillconvert.setText(calculationObj.getString("ConvertAmount") + "" + tv_currency_to.getText());
